...
func TestRenderDetailAcceptsShortContainerID(t *testing.T) {
	...
	view := RenderDetail(c, nil, "", []string{"log line"}, nil, "", "", 0, 80, 20, false, LogOrderOldest, LogSearch{})
...
func TestRenderDetailShowsPolishedMetadata(t *testing.T) {
	...
	view := RenderDetail(c, meta, "homedash", []string{"log line"}, nil, "", "", 0, 100, 24, false, LogOrderOldest, LogSearch{})
...
func TestRenderDetailSummarizesPublishedMetadataInNarrowWidth(t *testing.T) {
	...
	view := RenderDetail(c, meta, "homedash", []string{"log line"}, nil, "", "", 0, 44, 20, false, LogOrderOldest, LogSearch{})
	plain := stripANSI(view)
...
func TestRenderDetailShowsLiveWaitingState(t *testing.T) {
	...
	view := RenderDetail(c, nil, "", nil, nil, "", "", 0, 90, 20, true, LogOrderOldest, LogSearch{})
	plain := stripANSI(view)
...
func TestRenderDetailShowsLiveTitleWhenFollowingLoadedLogs(t *testing.T) {
	...
	view := RenderDetail(c, nil, "", []string{"line one", "line two"}, nil, "", "", 0, 90, 20, true, LogOrderOldest, LogSearch{})
	plain := stripANSI(view)
...
func TestRenderDetailShowsLogErrorState(t *testing.T) {
	...
	view := RenderDetail(c, nil, "", nil, assertErr("socket closed"), "", "", 0, 90, 20, false, LogOrderOldest, LogSearch{})
	plain := stripANSI(view)
